import { Heading, DataList, Stack, Text, Link } from "@chakra-ui/react";
...
const websiteUrl = "https://scspace.kws.sparcs.net";
const email = "scspace@kaist.ac.kr / scspace.kaist@gmail.com";
        ...
        <Stack>
            ...
            <DataList.Root variant="bold">
                ...
                <DataList.Item>
                    ...
                    <DataList.ItemValue>
                        (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to KAIST Student Culture & Space Committee official website.
                    </DataList.ItemValue>
                </DataList.Item>
                <DataList.Item>
                    <DataList.ItemLabel>
                ...
                <DataList.Item>
                    ...
                    <DataList.ItemValue>
                        refers to KAIST Student Culture & Space Committee official website, accessible from {websiteUrl}
                    </DataList.ItemValue>
                </DataList.Item>
                <DataList.Item>
                    <DataList.ItemLabel>
            ...
            <DataList.Root variant="bold">
                <DataList.Item>
                    <DataList.ItemLabel>
                        Email address (KAIST official)
                    </DataList.ItemLabel>
                </DataList.Item>
                <DataList.Item>
                    <DataList.ItemLabel>
                        First name and last name (for Korean and English both)
                    </DataList.ItemLabel>
                </DataList.Item>
                <DataList.Item>
                    <DataList.ItemLabel>
            ...
            <Text>
                Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <Link href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking" target="_blank" color="blue">Free Privacy Policy website</Link> article.
            </Text>
            <Text>
