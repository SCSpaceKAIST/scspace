...
export default function PerformanceLotteryNotice() {
    const notice: {
        ...
        eng: [
            { content: "You can select a time slot to apply for the performance lottery during intensive period.", },
        ...
        kor: [
            { content: "공연집중기간 추첨을 신청할 시간대를 선택할 수 있습니다.", },
            ...
            {
                content: "추첨 신청 전에 마이페이지 > 내 조직에서 단체실 보유 여부를 반드시 명시해주세요.",
                color: "red"
            },
