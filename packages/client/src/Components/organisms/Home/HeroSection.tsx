        ...
        >
            <VStack gap={heroGap} textAlign="center" px={{ base: 6, md: 12 }}>
                <VStack gap={3}>
                    ...
                    >
                        <Text>
                            <Mark fontWeight={"extrabold"}>S</Mark>tudent <Mark fontWeight={"extrabold"}>C</Mark>ulture & <Mark fontWeight={"extrabold"}>Space</Mark> Committee
                        </Text>
                    </Badge>
                ...
                <Text fontSize={{ base: "md", md: "lg" }} color="gray.600">
                    KAIST 장영신 학생회관과 미래홀 <Mark color="blue.500" fontWeight="semibold">공간 예약</Mark>부터, 의자, 책상 등
                    <Mark color="blue.500" fontWeight="semibold"> 물품 대여</Mark>까지 공간위의 모든 서비스를 한 곳에서 제공합니다.
                </Text>
            </VStack>
            <MotionBox
                position="absolute"
